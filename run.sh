...
x86_64-elf-gcc -c stdlibc/math.c -o objects/math.o -ffreestanding -nostdlib -m32
...
x86_64-elf-gcc -c sys/interupts.c -o objects/interupts.o -ffreestanding -nostdlib -m32
...
x86_64-elf-gcc -c applications/colormode/colormode.c -o objects/colormode.o -ffreestanding -nostdlib -m32


x86_64-elf-gcc -c kernel.c -o objects/kernel.o -ffreestanding -nostdlib -m32
x86_64-elf-ld -m elf_i386 -T linker.ld objects/interupts.o objects/shell.o objects/ramdisk.o objects/stored_screen.o objects/boot.o objects/snake.o objects/str.o objects/kernel.o objects/scr.o objects/vga.o objects/keyboard.o objects/error.o objects/heap.o objects/snake_special_functions.o objects/files.o objects/super.o objects/colormode.o objects/math.o -o objects/kernel.elf
